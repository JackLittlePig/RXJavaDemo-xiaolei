package com.xiaolei.rxjava.view;
...
import com.xiaolei.rxjava.HttpUtils.HttpUtils;
import com.xiaolei.rxjava.R;
import com.xiaolei.rxjava.cache.MyDiskCache;
import com.xiaolei.rxjava.cache.MyMemoryCache;
import com.xiaolei.rxjava.model.Course;
import com.xiaolei.rxjava.model.Student;
...
//        });
    ...
    public void concatAndFirstOperation() {
        ...
        Observable.concat(memory, disk, network)            //合并多个Observable
                .first()                                    //依次执行
                .subscribeOn(Schedulers.newThread())        //事件发生在子线程
                .observeOn(AndroidSchedulers.mainThread())  //事件消费(结束)发生在主线程
                .subscribe(s);
    }
